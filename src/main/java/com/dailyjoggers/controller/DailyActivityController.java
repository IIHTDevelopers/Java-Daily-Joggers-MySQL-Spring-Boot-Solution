...
public class DailyActivityController {
	...
	@GetMapping("/{userId}")
	public ResponseEntity<List<DailyActivityDTO>> getDailyActivityForUser(@PathVariable Long userId) {
		List<DailyActivityDTO> dailyActivityPage = dailyActivityService.getDailyActivityForUser(userId);
